...
for i in range(total):
    ...
    file = './../result/32node/DRSIR/TM10/'+ 'metrics' +  str(i+1)+ '.csv'
...
for i in range(total):
    ...
    delay_list[i] = delay_sum_temp/60
...
for i in range(total):
    ...
    average_uti = average_uti +avg_uti_temp/60
    throughput_sum = throughput_sum + throughput_temp/60
    mlu_list[i] = max_uti_temp 
    troughput_list[i] = throughput_temp/60
