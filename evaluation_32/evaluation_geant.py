...
for i in range(total):
    #file = './../ours//Metrics/'+str(init_num)+'_net_metrics.csv'
    file = './../ours_32node/Metrics/'+str(init_num+i)+'_net_metrics.csv'
    #file = './../2cluster_32node/Metrics/'+str(init_num+i)+'_net_metrics.csv'
    #file = './../temp/20230825/Metrics/'+str(init_num+i)+'_net_metrics.csv'
    #file = './../../temp2/20230802/test/tm'+str(init_num+i)+'_net_metrics.csv'
