...
def train(net):
    ...
    #tm_list = ['17','19','20','22','23','00','01','02','04','07','08','09','11','13','15']
    tm_list = ['13','15','17','19','20','22','23','00','01','02','04','07','08','09','11']
    #tm_list = ['00','01','02','04','07','08','09','11','13','15','17','19','20','22','23']
    for tm in tm_list:
        print("################################################")
        print(tm)
...
if __name__ == "__main__":
    ...
    while 1:
        input_ = input('CLI/TRA/TEST/KILL/SER/QUIT')
        if input_.upper() == 'CLI':
            CLI(net)
