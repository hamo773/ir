...
def DRL_thread():
    ...
    madqn_agents = agent.Agent((SIZE-1)*(SIZE-2), link_num*3,20)
    #madqn_agents = agent.Agent((SIZE-1)*(SIZE-2), link_num,20)
    ...
    while True:
        ...
        if step >= 3:
            #madqn_agents.append_sample(state_memory,action_memory[0], state,all_agent_reward_list)
            if step == 3:
                action_memory.pop(0)
            else:
                ...
                action_memory.pop(0)
            #madqn_agents.append_sample(state_memory,action_memory[0], state,all_agent_delta_reward_list)   #(s2,a1,r3-r2,s3)
            #print(state)
            #print(state_memory)
            #print(all_agent_action_list)
            #print(action_memory[0])
            #action_memory.pop(0)
