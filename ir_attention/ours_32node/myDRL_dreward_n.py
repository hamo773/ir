    ...
    while True:
        ...
        if step >= 3:
            ...
            if step ==3:
                ...
                action_memory.pop(0)
            #madqn_agents.append_sample(state_memory,action_memory[0], state,all_agent_delta_reward_list,path_vector_memory)   #(s2,a1,p1,r3-r2,s3)
            #madqn_agents.append_sample(state_memory,action_memory, state,all_agent_reward_list,path_vector_memory)
...
def path_metrics_to_reward():
        ...
        for j in paths_metrics_dict[i]:
            ...
            for m in metrics:
                if m == metrics[0]:
                    ...
                    for val in paths_metrics_dict[str(i)][str(j)][m][0]:
                        if val >1 : #ensure minimum bwd available
                            temp = 1/val
    ...
    #print(paths_metrics_dict[str(1)][str(2)]['bwd_paths'][0])
    #print(max(paths_metrics_dict[str(1)][str(2)]['bwd_paths'][0]))
